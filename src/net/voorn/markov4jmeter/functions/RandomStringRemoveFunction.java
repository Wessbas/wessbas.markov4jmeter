...
public class RandomStringRemoveFunction extends AbstractFunction implements
		Serializable {
	...
	public String execute(SampleResult arg0, Sampler currentSampler)
		...
		JMeterVariables jMeterVariables = currentSampler.getThreadContext()
				.getVariables();
		String parameterValue = jMeterVariables.get(this.parameterName);

		StringTokenizer tokenizer = new StringTokenizer(parameterValue,
				this.delimiter);
